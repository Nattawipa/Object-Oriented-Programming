...
public class Player {
	...
	{	
		...
		this.type = _type;
		switch(this.type)  //switching type of player and set it information
		{
			case Healer:
	...
	{
		//INSERT YOUR CODE HERE
		return currentHP;        //return value of currentHP
	}
	...
	{
		//INSERT YOUR CODE HERE
		return type;             //return type of character
	}
	...
	public double getMaxHP()
	{
		...
		return maxHP;     //return value of maxHP
	}
	...
	{
		//INSERT YOUR CODE HERE
		if(Sleeping)                //return sleeping in true or false
		{
			return true;
		}
		return false;
	...
	{
		//INSERT YOUR CODE HERE
		if(Cursed)                   //return cursed in true or false
		{
			return true;
		}
		return false;
	 ...
	 * @return
	 */
	public boolean isAlive()      //check the player is alive or not ?
	{
		//INSERT YOUR CODE HERE
		if(currentHP>0)         //return is currentHP>0 in true or false
		{
			return true;
		}
		return false;
	...
	{
		//INSERT YOUR CODE HERE
		if(Taunting)           //return taunting in true or false
		{
			return true;
		}
		return false;
	...
	{	
		//INSERT YOUR CODE HERE
		target.currentHP = target.currentHP -  this.atk;   //attack target
	...
	{	
		//INSERT YOUR CODE HERE
		num =0;
		if(this.type == PlayerType.Healer)       //if it type is Healer then do the process below
		{
		...
		else if(this.type == PlayerType.Tank)        //if it type is Tank then do the process below
		{
			System.out.println("# "+playerInfo()+" is Taunting");
			setTaunting(true);
		}
		else if(this.type == PlayerType.BlackMage)      //if it type is Blackmage then do the process below
		{
			double min = 9999999;
			Player cursing = null;
		...
		else if(this.type == PlayerType.Cherry)    //if it type is Cherry then do the process below
		{
			for (int i = 0; i < 2; i++) 
			{
		...
		else if (this.type == PlayerType.Phoenix)   //if it type is Phoenix then do the process below
		{
	 ...
	 * @param arena
	 */
	public void takeAction(Arena arena)      //take action of the arena
	{	
		//INSERT YOUR CODE HERE
	 ...
	 */
	@Override
	public String toString()      //return output in this pattern below
	{
	...
	public Player Taunting(Player[][] team)      //player taunting
	{
		for (int i = 0; i < 2; i++) 
		{
	...
	public String playerInfo()    //pattern of method playerInfo 
	{
		return this.Name_of_team+"["+this.row_of_team+"]["+this.position_of_team+"] {"+this.type.toString()+"}";
	}
	public void setPosition(int position,String teamName,String Row)   //set position , teamName , Row
	{
		this.position_of_team = position;
		this.Name_of_team = teamName;
		this.row_of_team = Row;
	}
	public void setSleeeping(boolean isSleeeping)    //set value of Sleeping in true or false
	{
		this.Sleeping = isSleeeping;
	}
	public void setTaunting(boolean isTaunting)      //set value of Taunting in true or false
	{
		this.Taunting = isTaunting;
	} 
	public void setCursed(boolean isCursed)          //set value of Cursed in true or false
	{
